            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input class="form-check-input" type="radio" wire:model="est_admin" id="gridRadios1" value="1" checked>
                        <label class="form-check-label" for="gridRadios1">
                          Occupé
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" wire:model="est_admin" id="gridRadios2" value="0">
                        <label class="form-check-label" for="gridRadios2">
                          Libre
                        </label>
                      </div>
                        @error('est_admin') <span class="text-danger error">{{ $message }}</span>@enderror
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
